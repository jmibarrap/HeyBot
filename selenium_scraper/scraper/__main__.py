...
def call_scraper(**kwargs):
    ...
    if USER_UNAME is not None and USER_PASSWORD is not None:
        ...
        scraper.login()
        scraper.scrape_tweets(
            max_tweets=kwargs["tweets"] if "tweets" in kwargs else 10,
...
if __name__ == "__main__":
    #call_scraper(tweets=10, query="heybanco (from:AngelGa35156959)")
    call_scraper(tweets=10, username="elonmusk")
